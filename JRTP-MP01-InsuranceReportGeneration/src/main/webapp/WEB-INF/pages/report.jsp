...
<hr>
<frm:form action="report" modelAttribute="ic" class="row g-3" method="POSt">
...
<c:if test="${!page.isFirst()}">
	<a href="./search?page=0">First Page</a>
	<a href="./search?page=${page.getNumber()-1}">Previous</a>
</c:if>

<c:forEach begin="0" end="${page.getTotalPages()-1}" step="1" varStatus="status">
	<a href="./search?page=${status.count}">${status.count}</a>
</c:forEach>

<c:if test="${!page.isLast()}">
    <a href="./search?page=${page.getNumber()+1}">Next Page</a>
	<a href="./search?page=${page.getTotalPages()-1}">Last Page</a>
</c:if>
